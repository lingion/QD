...
def qobuz_dl_args(
    ...
    parser.add_argument(
        ...
        help=f"下载保存目录 (默认: {default_folder})"
    )

    # 功能开关
    parser.add_argument("-r", "--reset", action="store_true", help="重置配置文件 (修改 Token)")
    ...
    parser.add_argument("-s", "--smart-discography", action="store_true", help="智能筛选 (下载艺人时过滤重复/杂乱专辑)")
